...
const enStrings = <String, String>{
  ...
  'settingsBackupIntro':
      'Export all your data to a file, or restore from a previous backup.',
...
const zhStrings = <String, String>{
  ...
  'settingsBackupIntro': '将所有数据导出到文件，或从备份文件恢复。',
  'backupCreate': '创建备份',
  'backupCreateDesc': '将设置、会话和任务导出为 zip 文件。',
  'backupExport': '导出',
  'backupRestore': '从备份恢复',
  'backupRestoreDesc': '从备份文件导入数据，将覆盖当前数据。',
  'backupImport': '导入',
  'backupCreated': '已创建备份，包含 {count} 个文件。',
  'backupRestored': '已恢复 {count} 个文件。重启后生效。',
  'backupFailed': '备份失败',
  'searchSettings': '搜索设置…',
