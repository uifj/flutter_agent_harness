...
class StressTestBoardState extends State<StressTestBoard> {
  late final BoardPanelController controller;
  late final BoardPanelScrollController boardScrollController;
  ...
  void initState() {
    super.initState();
    boardScrollController = BoardPanelScrollController();
  ...
  void _initializeBoard() {
    ...
    for (int g = 0; g < config.groupCount; g++) {
      ...
      final items = <BoardPanelGroupItem>[];
  ...
  Widget _buildCard(BoardPanelGroupItem item) {
...
class SimpleItem extends BoardPanelGroupItem {
  @override
  final String id;
  final String title;
...
class LargeContentItem extends BoardPanelGroupItem {
  @override
  final String id;
  final String title;
...
class SpecialCharItem extends BoardPanelGroupItem {
  @override
  final String id;
  final String content;
...
class VariableHeightItem extends BoardPanelGroupItem {
  @override
  final String id;
  final String title;
  final int lines;
