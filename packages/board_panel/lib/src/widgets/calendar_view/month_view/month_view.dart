...
class MonthView<T extends Object?> extends StatefulWidget {
  ...
  final CalendarCellBuilder<T>? cellBuilder;
...
class MonthViewState<T extends Object?> extends State<MonthView<T>> {
  ...
  late CalendarCellBuilder<T> _cellBuilder;
                          ...
                          builder: (context, constraints) {
                            ...
                            return SizedBox(
                              ...
                              child: _MonthPageBuilder<T>(
                                ...
                                // Themed border only when the default constant
                                // is still in use.
                                borderColor:
                                    widget.borderColor ==
  ...
  Widget _defaultCellBuilder(
    ...
    return FilledCell<T>(
      ...
      backgroundColor: isInMonth
          ? (theme?.colorScheme.background ?? Constants.white)
          : (theme?.colorScheme.muted ?? Constants.offWhite),
      events: events,
