...
class RoundedEventTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Resolve the themed color only when the caller kept the hardcoded
    // default.
    final effectiveBackground = backgroundColor == Colors.blue
        ? (ShadTheme.maybeOf(context)?.colorScheme.primary ?? backgroundColor)
        : backgroundColor;
    return Container(
      padding: padding,
      margin: margin,
          ...
          if (title.isNotEmpty)
            Expanded(
              child: Text(
                ...
                style:
                    titleStyle ??
                    TextStyle(fontSize: 20, color: effectiveBackground.accent),
                softWrap: true,
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style:
                      ...
                      TextStyle(
                        fontSize: 17,
                        color: effectiveBackground.accent.withAlpha(200),
                      ),
                ),
              ),
            ),
    ...
    return Transform.translate(
      ...
      child: Padding(
        ...
        child: Text(
          ...
          style: markingStyle ?? const TextStyle(fontSize: 15.0),
        ),
      ),
    );
  }
