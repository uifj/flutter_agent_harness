...
extension ColorExtension on Color {
  /// Returns a readable foreground color for this background color.
  ///
  /// Migrated off the deprecated `red`/`green`/`blue` int accessors to the
  /// 0..1 `r`/`g`/`b` channels; the threshold semantics are preserved
  /// (any channel at or above 50% intensity yields a dark foreground).
  Color get accent =>
      (r >= 0.5 || g >= 0.5 || b >= 0.5) ? Colors.black : Colors.white;
}
