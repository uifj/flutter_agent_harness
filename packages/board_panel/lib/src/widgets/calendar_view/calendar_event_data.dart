...
class CalendarEventData<T extends Object?> {
  ...
  /// Hash is derived from the strictly-equal fields of [operator ==] only
  /// (date/time fields use fuzzy comparison there), which keeps the
  /// equals/hashCode contract: equal objects always share the same hash.
  @override
