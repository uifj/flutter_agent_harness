...
class DayView<T extends Object?> extends StatefulWidget {
  ...
  const DayView({
    ...
    this.onHeaderTitleTap,
         ...
         !(onHeaderTitleTap != null && dayTitleBuilder != null),
...
class DayViewState<T extends Object?> extends State<DayView<T>> {
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return ValueListenableBuilder(
                            ...
                            builder: (_, _, _) => InternalDayViewPage<T>(
                              key: ValueKey(
  ...
  void _updateViewDimensions() {
    ...
    _halfHourIndicatorSettings =
        widget.halfHourIndicatorSettings ??
        HourIndicatorSettings(
          height: widget.heightPerMinute,
          color: theme?.colorScheme.border ?? Constants.defaultBorderColor,
          offset: 5,
    ...
    return DayPageHeader(
      ...
      onTitleTapped: () async {
        if (widget.onHeaderTitleTap != null) {
          ...
          // consumer's callback.
          unawaited(widget.onHeaderTitleTap!(date));
        } else {
