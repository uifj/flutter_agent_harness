...
class BoardPhantomController extends OverlapDragTargetDelegate
  ...
  BoardPhantomController({required this.delegate, required this.groupsState});

  final BoardPhantomControllerDelegate delegate;
  final BoardPanelState groupsState;
  ...
  void dragTargetDidMoveToReorderFlex(
    ...
    acceptNewDragTargetData(reorderFlexId, dragTargetData, dragTargetIndex);
  }
...
class PhantomGroupItem extends BoardPanelGroupItem {
...
class PassthroughPhantomContext extends FakeDragTargetEventTrigger
  ...
  BoardPanelGroupItem get itemData =>
      dragTargetData.reorderFlexItem as BoardPanelGroupItem;
