...
import '../utils/utils.dart' show TextFormatter;
...
class HeaderStyle {
  ...
  ///
  /// When null, the shadcn theme's `h4` text style is used if a ShadTheme
  /// ancestor exists; otherwise falls back to the original Slate style.
  final TextStyle? titleTextStyle;

  /// Style for FormatButton `Text`.
  ///
  /// When null, the shadcn theme's `small` text style is used if a ShadTheme
  /// ancestor exists; otherwise falls back to the original Slate style.
  ...
  ///
  /// When null, the shadcn theme's background color is used if a ShadTheme
  /// ancestor exists; otherwise the header is undecorated (as before).
  ...
  const HeaderStyle({
    ...
    this.leftChevronIcon = const Icon(LucideIcons.chevronLeft),
    this.rightChevronIcon = const Icon(LucideIcons.chevronRight),
