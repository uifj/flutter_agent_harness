...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.rangeHighlightColor = const Color(0xFFE2E8F0),
    ...
    this.outsideTextStyle = const TextStyle(color: Color(0xFF94A3B8)),
    this.outsideDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.disabledTextStyle = const TextStyle(color: Color(0xFFCBD5E1)),
    this.disabledDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.holidayTextStyle = const TextStyle(color: Color(0xFF3B82F6)),
    this.holidayDecoration = const BoxDecoration(
      border: Border.fromBorderSide(
        BorderSide(color: Color(0xFF93C5FD), width: 1.4),
      ),
      shape: BoxShape.circle,
    ),
    this.weekendTextStyle = const TextStyle(color: Color(0xFF64748B)),
