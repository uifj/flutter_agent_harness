...
class DefaultCellCard extends StatelessWidget {
  ...
  const DefaultCellCard({super.key, required this.child});
...
class _MyHomePageState extends State<MyHomePage> {
            ...
            ? const DefaultCellCard(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Text('This is row legend', style: textStyle),
                  ),
                ),
              )
            : null,
  ...
  ExpandableTable _buildExpandableTable() {
    ...
    final List<ExpandableTableHeader> subHeader = List.generate(
      subColumnsCount,
      (index) => ExpandableTableHeader(cell: _buildCell('&Sub Column $index')),
    );
