...
import 'package:board_panel/src/utils/simple_gesture_detector.dart';
...
void main() {
  group('Correct days are displayed for given focusedDay when:', () {
    testWidgets('in month format, starting day is Sunday', (tester) async {
    ...
    testWidgets('in two weeks format, starting day is Sunday', (tester) async {
      final focusedDay = DateTime.utc(2021, 7, 15);
    ...
    testWidgets('in week format, starting day is Sunday', (tester) async {
      final focusedDay = DateTime.utc(2021, 7, 15);
    ...
    testWidgets('in month format, starting day is Monday', (tester) async {
      final focusedDay = DateTime.utc(2021, 7, 15);
    ...
    testWidgets('in two weeks format, starting day is Monday', (tester) async {
      final focusedDay = DateTime.utc(2021, 7, 15);
    ...
    testWidgets('in week format, starting day is Monday', (tester) async {
      final focusedDay = DateTime.utc(2021, 7, 15);
  ...
  testWidgets('Callbacks return expected values', (tester) async {
    ...
    // Swipe left
    await tester.drag(find.byKey(dateToKey(focusedDay)), const Offset(-500, 0));
    await tester.pumpAndSettle();
    expect(focusedDay.month, nextMonth);

    // Swipe up
    await tester.drag(find.byKey(dateToKey(focusedDay)), const Offset(0, -500));
    await tester.pumpAndSettle();
