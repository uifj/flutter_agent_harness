...
import 'package:board_panel/src/widgets/table_calendar/calendar_page.dart';
...
void main() {
  testWidgets('CalendarPage lays out all the visible days', (tester) async {
  ...
  testWidgets('CalendarPage lays out 7 DOW labels', (tester) async {
    await tester.pumpWidget(
      setupTestWidget(
        CalendarPage(
          visibleDays: visibleDays,
  ...
  testWidgets('Week numbers are not visible by default', (tester) async {
    await tester.pumpWidget(
      setupTestWidget(
        CalendarPage(
          visibleDays: visibleDays,
    ...
    expect(find.byType(Column), findsNWidgets(0));
  });

  testWidgets('Week numbers are visible', (tester) async {
    await tester.pumpWidget(
      setupTestWidget(
        CalendarPage(
          visibleDays: visibleDays,
